...
const DESTROYED_FIELD_STATUS = {
  node: FIELD_NODE_STATUSES.DESTROYED,
  content: FIELD_CONTENT_STATUSES.EMPTY,
  validation: {
    status: FIELD_VALIDATION_STATUSES.UNKNOWN,
    invalidValidators: [],
  },
  readiness: FIELD_READINESS_STATUSES.DESTROYED,
  focus: FIELD_FOCUS_STATUSES.UNFOCUSED,
  enabling: FIELD_ENABLING_STATUSES.DISABLED,
};
...
const FIELD_STATUSES = {
  ...
  DESTROYED: DESTROYED_FIELD_STATUS,
